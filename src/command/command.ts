...
yargs(hideBin(process.argv))
  .command(
    "add",
    "Add a videogame to the collection",
    {
      user: {
        type: "string" as const,
        demandOption: true,
  ...
  .command(
    "remove",
    "Remove a videogame from the collection",
    {
  ...
  .command(
    "update",
    "Update a videogame in the collection",
    {
      user: { type: "string" as const, demandOption: true },
      id: { type: "number" as const, demandOption: true },
      ...videogameOptions,
